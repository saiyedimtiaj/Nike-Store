...
import MultiRangeSlider from "../../Components/AllProduct/MultiRange/MultiRangeSlider";
...
const AllProducts = () => {
  ...
  const { data: products = [], refetch } = useQuery({
    ...
    queryFn: () =>
      axios
        .get(
          `/allproduct?sortBy=${sortValue}&sortField=${sortField}&currentPage=${currentPage}&category=${category}&minVal=${minVal}&maxVal=${maxVal}`
        )
        .then((res) => {
          return res.data;
        }),
      ...
      <div className="flex flex-col md:flex-row gap-8 items-start">
        <div className="col-span-1 py-6 px-5">
          ...
          <div className="flex justify-between gap-4 items-center">
            <div className="">
              ...
              <input
                value={minVal}
                className="border-2 border-black w-[70px] px-2 py-1.5"
                type="number"
              />
            </div>
        ...
        <div className="flex-1">
          <div className="border-2 flex justify-between mb-5 py-4 px-3 items-center border-gray-600">
            <p>
              Showing {currentPage === 0 ? 1 : currentPage * 6 + 1}-
              {(currentPage + 1) * 6} of {pageCount}
            </p>
